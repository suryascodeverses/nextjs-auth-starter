...
This happens when using localStorage on the server side. The code already handles this, but if you see it:
- Check that localStorage calls are wrapped in client components
...
- Check endpoint paths match your backend
...
- Start with dummy data mode to develop the frontend
- Switch to API mode when backend is ready
- Use browser DevTools to inspect localStorage
- Check Network tab to see API calls
- The API status indicator on home page shows current mode
